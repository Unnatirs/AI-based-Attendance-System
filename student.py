...
class Student:
    def __init__(self,root):
        ...
        img2 = Image.open(r"C:\Users\Dell\OneDrive\Desktop\face_recongition_system\images\stu3.jpg")
        ...
        dept_combo=ttk.Combobox(current_course_frame,textvariable=self.var_dep,font=("times new roman",13,"bold"),width=20,state="read only")
        dept_combo["values"]=("Select Department","Computer","Electrical","Civil","Meachnical","Electronic","MCA","MBA")
        ...
        semester_combo["values"]=("Select Semester","Odd Semester","Even Semester")
        ...
        #student id
        StudentId_label=Label(class_student_frame,text="Studentb ID:",font=("times new roman",13,"bold"),bg="white")
        ...
        division_combo=ttk.Combobox(class_student_frame,textvariable=self.var_div,font=("times new roman",13,"bold"),width=18,state="read only")
        ...
        #Teacher Guardian
        guardian_label=Label(class_student_frame,text="Teacher Guardian:",font=("times new roman",13,"bold"),bg="white")
        ...
        reset_btn=Button(btn_frame,text="Reset",command=self.reset_data,width=17,font=("times new roman",13,"bold"),bg="yellow",fg="black")
        ...
        img_right = Image.open(r"C:\Users\Dell\OneDrive\Desktop\face_recongition_system\images\stu4.jpg")
        ...
        search_combo["values"]=("Select","Roll_No","Phone_No","TE","BE")
    ...
    def add_data(self):
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:
                ...
                self.fetch_data()
                conn.close()
                messagebox.showinfo("sucess","Student details has been added",parent=self.root)
        ...
        if self.var_dep.get()=="Select Department" or self.var_std_name.get()=="" or self.var_std_id.get()=="":
            ...
            try:
                ...
                if Update>0:
                    conn=mysql.connector.connect(host="localhost",username="root",password="unnati",database="attendance_system")
                    my_cursor=conn.cursor()
                    my_cursor.execute("update student set Dep=%s,course=%s,Year=%s,Semester=%s,Name=%s,Division=%s,Roll=%s,Gender=%s,Dob=%s,Email=%s,Phone=%s,Address=%s,Guardian=%s,PhotoSample=%s where Student_id=%s",(
    ...
    def delete_data(self):
        if self.var_std_id.get()=="":
            ...
            try:
                ...
                self.fetch_data()
                conn.close()
                messagebox.showinfo("Delete","Sucessfully deleted student datails",parent=self.root)
            except Exception as es:
                messagebox.showerror("Eror",f"Due To:{str(es)}",parent=self.root)
...
#========generate dataset and take a photosample======
